...
function formatSparkSql(sql: string, config: FormatOptionsWithLanguage): string {
...
function formatHiveSql(sql: string, config: FormatOptionsWithLanguage): string {
...
function formatFlinkSql(sql: string, config: FormatOptionsWithLanguage): string {
...
function formatWithFallback(sql: string, config: FormatOptionsWithLanguage): string {
    try {
 ...
 */
function formatPartialSql(sql: string, config: FormatOptionsWithLanguage): string | null {
