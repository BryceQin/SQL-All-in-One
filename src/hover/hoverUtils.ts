...
export function extractWordAtPosition(document: vscode.TextDocument, position: vscode.Position): string | null {
...
export function buildParameterMarkdown(paramName: string, locations: { line: number; context: string }[]): vscode.MarkdownString {
    const md = new vscode.MarkdownString();
    md.isTrusted = true;
