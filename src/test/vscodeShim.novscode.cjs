...
class EventEmitter {
    event(_listener) { return { dispose() { /* no-op */ } } }
    fire(_e) { /* no-op */ }
    dispose() { /* no-op */ }
}

class Disposable {
    constructor(_fn) { /* no-op */ }
    static from(..._disposables) { return { dispose() { /* no-op */ } } }
    dispose() { /* no-op */ }
}

class Uri {
    static parse(_s) { return new Uri() }
    static file(_p) { return new Uri() }
    toString() { return 'vscode-shim-uri://' }
    with(_changes) { return new Uri() }
}

class Location {
    constructor(_uri, _rangeOrPos) { /* no-op */ }
}

class Range {
    constructor(_a, _b, _c, _d) { /* no-op */ }
    get start() { return { line: 0, character: 0 } }
    get end() { return { line: 0, character: 0 } }
}

class Position {
    constructor(_l, _c) { /* no-op */ }
    get line() { return 0 }
    ...
    workspace: {
        getConfiguration(_section) {
            return {
                ...
                update(_key, _value) { return Promise.resolve() },
            }
        },
        onDidCloseTextDocument(_cb) { return { dispose() { /* no-op */ } } },
        onDidChangeTextDocument(_cb) { return { dispose() { /* no-op */ } } },
        onDidOpenTextDocument(_cb) { return { dispose() { /* no-op */ } } },
        onDidSaveTextDocument(_cb) { return { dispose() { /* no-op */ } } },
        textDocuments: [],
        workspaceFolders: [],
    },
    window: {
        ...
        showErrorMessage(_m) { return Promise.resolve(undefined) },
        showWarningMessage(_m) { return Promise.resolve(undefined) },
        showInformationMessage(_m) { return Promise.resolve(undefined) },
        activeTextEditor: undefined,
        onDidChangeActiveTextEditor(_cb) { return { dispose() { /* no-op */ } } },
        onDidChangeTextEditorSelection(_cb) { return { dispose() { /* no-op */ } } },
    },
    commands: {
        registerCommand(_id, _cb) { return { dispose() { /* no-op */ } } },
        executeCommand(_id, ..._args) { return Promise.resolve(undefined) },
    },
    languages: {
        registerCompletionItemProvider(_sel, _p) { return { dispose() { /* no-op */ } } },
        registerHoverProvider(_sel, _p) { return { dispose() { /* no-op */ } } },
        registerDefinitionProvider(_sel, _p) { return { dispose() { /* no-op */ } } },
        registerReferenceProvider(_sel, _p) { return { dispose() { /* no-op */ } } },
        registerRenameProvider(_sel, _p) { return { dispose() { /* no-op */ } } },
        registerCodeActionsProvider(_sel, _p) { return { dispose() { /* no-op */ } } },
        registerFoldingRangeProvider(_sel, _p) { return { dispose() { /* no-op */ } } },
        registerDocumentSymbolProvider(_sel, _p) { return { dispose() { /* no-op */ } } },
        createDiagnosticCollection(_name) {
            return {
                set(_uri, _diags) { /* no-op */ },
                delete(_uri) { /* no-op */ },
                clear() { /* no-op */ },
                dispose() { /* no-op */ },
            }
        },
        onDidChangeDiagnostics(_cb) { return { dispose() { /* no-op */ } } },
    },
}
