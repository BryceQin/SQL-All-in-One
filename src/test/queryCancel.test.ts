...
function createMockAdapter(
    options: { supportsCancel?: boolean; neverResolve?: boolean } = {},
): DatabaseAdapter & { cancelQueryCalled: boolean; cancelQueryCallCount: number } {
    ...
    const mock = {
        ...
        get cancelQueryCalled() {
            return cancelQueryCalled;
        },
        get cancelQueryCallCount() {
            return cancelQueryCallCount;
        },
