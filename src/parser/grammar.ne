...
@{%
import LexerAdapter from './LexerAdapter.ts';
import { NodeType, AstNode, CommentNode, KeywordNode, IdentifierNode, DataTypeNode } from './ast.ts';
