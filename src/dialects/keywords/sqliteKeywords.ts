...
export const sqliteKeywords: KeywordInfo[] = [
    {
        ...
        description: "插入或替换行（UPSERT 语义）",
        category: "dml",
        example: "REPLACE INTO employees (id, name) VALUES (1, 'Alice')",
    },
    {
        keyword: "AUTOINCREMENT",
        syntax: "col_name INTEGER PRIMARY KEY AUTOINCREMENT",
        description: "自动递增列属性",
        category: "hint",
    ...
    },
    {
        ...
        description: "仅在表不存在时创建",
        category: "ddl",
        example: "CREATE TABLE IF NOT EXISTS employees (id INTEGER PRIMARY KEY)",
    },
    {
        keyword: "ATTACH",
        syntax: "ATTACH DATABASE 'path' AS alias",
        description: "附加外部数据库文件",
        category: "auxiliary",
        example: "ATTACH DATABASE './other.db' AS other",
    },
