...
export const mysqlKeywords: KeywordInfo[] = [
    {
        keyword: "REPLACE",
        syntax: "REPLACE INTO table (col1, col2) VALUES (val1, val2)",
        description: "插入或替换行（如主键存在则删除旧行并插入新行）",
        category: "dml",
        example: "REPLACE INTO employees (id, name) VALUES (1, 'Alice')",
    },
    {
        keyword: "AUTO_INCREMENT",
        syntax: "col_name INT AUTO_INCREMENT",
        description: "自动递增列属性",
        category: "hint",
    ...
    {
        keyword: "ENGINE",
        syntax: "ENGINE = InnoDB | MyISAM | ...",
        description: "指定表的存储引擎",
        category: "hint",
        example: "CREATE TABLE t (id INT) ENGINE = InnoDB",
    },
    {
        keyword: "CHARSET",
        ...
        description: "指定表的字符集",
        category: "hint",
        example: "CREATE TABLE t (id INT) CHARSET = utf8mb4",
    },
    {
        keyword: "COLLATE",
        syntax: "COLLATE = collation_name",
        description: "指定表的排序规则",
        category: "hint",
        example: "CREATE TABLE t (name VARCHAR(100)) COLLATE = utf8mb4_general_ci",
    },
    {
        keyword: "ENUM",
        syntax: "ENUM('val1', 'val2', ...)",
        description: "枚举类型，值限定在指定列表中",
        category: "type",
