...
export const baseKeywords: KeywordInfo[] = [
    ...
    },
    {
        ...
        description: "对分组后的结果进行过滤（类似于 WHERE，但用于聚合后）",
        category: "query",
        example: "SELECT dept, COUNT(*) AS cnt FROM employees GROUP BY dept HAVING cnt > 5",
    },
    {
        keyword: "ORDER BY",
        syntax: "ORDER BY expr [ASC|DESC], ...",
        description: "对结果集按一个或多个列排序",
        category: "query",
    ...
    {
        keyword: "DISTINCT",
        syntax: "SELECT DISTINCT expr1, expr2, ...",
        description: "去除查询结果中的重复行",
        category: "query",
    ...
    },
    {
        ...
        description: "为列或表指定别名",
        category: "query",
        example: "SELECT COUNT(*) AS total FROM employees",
    },
    ...
    { keyword: "SOME", syntax: "expr operator SOME (subquery)", description: "ANY 的同义词", category: "query" },
    {
        ...
        description: "判断子查询是否返回任何行",
        category: "query",
        example: "SELECT * FROM orders WHERE EXISTS (SELECT 1 FROM customers WHERE customers.id = orders.customer_id)",
    },
    {
        keyword: "BETWEEN",
        ...
        category: "query",
        example: "SELECT * FROM employees WHERE salary BETWEEN 3000 AND 8000",
    },
    {
        keyword: "LIKE",
        syntax: "expr LIKE pattern",
        description: "使用通配符进行模式匹配（% 任意字符，_ 单个字符）",
        category: "query",
        example: "SELECT * FROM employees WHERE name LIKE '张%'",
    },
    {
        keyword: "IN",
        syntax: "expr IN (value1, value2, ...)",
        description: "判断值是否在指定列表或子查询结果中",
        category: "query",
        example: "SELECT * FROM employees WHERE dept IN ('IT', 'HR')",
    },
    {
        keyword: "IS NULL",
        syntax: "expr IS NULL",
    ...
    { keyword: "NOT", syntax: "NOT condition", description: "逻辑非，取反条件", category: "query" },
    {
        ...
        description: "用于根据两个或多个表之间的相关列来组合行",
        category: "join",
        example: "SELECT a.name, b.order_id\nFROM customers a\nINNER JOIN orders b ON a.id = b.customer_id",
    },
    {
        keyword: "INNER JOIN",
        syntax: "table1 INNER JOIN table2 ON condition",
        description: "内连接，仅返回两表中匹配的行",
        category: "join",
        example: "SELECT a.name, b.order_id FROM customers a INNER JOIN orders b ON a.id = b.customer_id",
    },
    {
        keyword: "LEFT JOIN",
        syntax: "table1 LEFT [OUTER] JOIN table2 ON condition",
        description: "左外连接，返回左表所有行，右表无匹配则为 NULL",
        category: "join",
        example: "SELECT a.name, b.order_id FROM customers a LEFT JOIN orders b ON a.id = b.customer_id",
    },
    {
        keyword: "RIGHT JOIN",
        syntax: "table1 RIGHT [OUTER] JOIN table2 ON condition",
        description: "右外连接，返回右表所有行，左表无匹配则为 NULL",
        category: "join",
    },
    {
        keyword: "FULL JOIN",
        syntax: "table1 FULL [OUTER] JOIN table2 ON condition",
        description: "全外连接，返回两表所有行，无匹配则为 NULL",
        category: "join",
    },
    { keyword: "CROSS JOIN", syntax: "table1 CROSS JOIN table2", description: "交叉连接，返回两表的笛卡尔积", category: "join" },
    {
        ...
        description: "自然连接，自动按两表同名列进行等值连接",
        category: "join",
    },
    ...
    },
    {
        ...
        description: "合并两个查询结果集，保留所有行（不去重）",
        category: "setop",
        example: "SELECT name FROM employees UNION ALL SELECT name FROM contractors",
    },
    ...
    { keyword: "MINUS", syntax: "query1 MINUS query2", description: "EXCEPT 的同义词（Oracle 语法）", category: "setop" },
    {
        ...
        description: "向表中插入数据",
        category: "dml",
        example: "INSERT INTO employees (name, dept) VALUES ('Alice', 'IT')",
    },
    {
        keyword: "INSERT OVERWRITE",
        syntax: "INSERT OVERWRITE TABLE target SELECT ...",
        description: "覆盖写入目标表数据（Hive/Spark）",
        category: "dml",
        example: "INSERT OVERWRITE TABLE target_table SELECT * FROM source_table",
    },
    {
        keyword: "UPDATE",
        syntax: "UPDATE table SET col1 = val1 WHERE condition",
        description: "修改表中满足条件的行",
        category: "dml",
        example: "UPDATE employees SET salary = 6000 WHERE name = 'Alice'",
    },
    {
        keyword: "DELETE",
        syntax: "DELETE FROM table WHERE condition",
        description: "删除表中满足条件的行",
        category: "dml",
    ...
    { keyword: "CREATE VIEW", syntax: "CREATE VIEW view_name AS SELECT ...", description: "创建视图", category: "ddl" },
    {
        ...
        description: "修改表结构或属性",
        category: "ddl",
        example: "ALTER TABLE employees ADD COLUMN email STRING",
    },
    ...
    {
        keyword: "OVER",
        syntax: "window_function() OVER ([PARTITION BY expr] [ORDER BY expr [frame_clause]])",
        description: "定义窗口函数的窗口规范",
        category: "window",
        example: "SELECT name, salary, ROW_NUMBER() OVER (PARTITION BY dept ORDER BY salary DESC) AS rank\nFROM employees",
    },
    ...
    { keyword: "RANGE BETWEEN", syntax: "RANGE BETWEEN start AND end", description: "定义窗口的值范围框架", category: "window" },
    {
        ...
        syntax: "ROWS BETWEEN UNBOUNDED PRECEDING AND ...",
        description: "窗口框架起始边界，表示分区第一行",
        category: "window",
    },
    { keyword: "CURRENT ROW", syntax: "ROWS BETWEEN ... AND CURRENT ROW", description: "窗口框架边界，表示当前行", category: "window" },
    {
        ...
        syntax: "ROWS BETWEEN ... AND UNBOUNDED FOLLOWING",
        description: "窗口框架结束边界，表示分区最后一行",
        category: "window",
    },
    ...
    {
        keyword: "SHOW",
        syntax: "SHOW TABLES | SHOW DATABASES | SHOW PARTITIONS table",
        description: "显示数据库对象信息",
        category: "auxiliary",
        example: "SHOW TABLES",
    },
    {
        keyword: "DESCRIBE",
        syntax: "DESCRIBE [FORMATTED|EXTENDED] table_name",
        description: "显示表或列的结构信息",
        category: "auxiliary",
        example: "DESCRIBE FORMATTED employees",
    },
    ...
    {
        keyword: "ELSE",
        syntax: "CASE ... ELSE default_result END",
        description: "CASE 表达式中所有条件不满足时的默认值",
        category: "conditional",
    },
    { keyword: "END", syntax: "CASE ... END", description: "结束 CASE 表达式", category: "conditional" },
    {
        ...
        category: "conditional",
        example: "SELECT IF(salary > 5000, '高', '低') AS level FROM employees",
    },
    {
        keyword: "COALESCE",
        syntax: "COALESCE(val1, val2, ...)",
        description: "返回参数列表中第一个非 NULL 的值",
        category: "conditional",
        example: "SELECT COALESCE(phone, email, 'N/A') AS contact FROM employees",
    },
    {
        keyword: "NULLIF",
        syntax: "NULLIF(expr1, expr2)",
        description: "如果两个表达式相等则返回 NULL，否则返回第一个表达式",
        category: "conditional",
    },
