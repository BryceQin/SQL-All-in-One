...
const reservedClauses = expandPhrases([...ORACLE_RESERVED_CLAUSES, "LIMIT"]);

// Dameng reuses Oracle's DDL tabular clauses and appends its own TOP clause.
const tabularOnelineClauses = expandPhrases([...ORACLE_DDL_TABULAR_ONELINE_CLAUSES, "TOP"]);
...
export const dameng: DialectOptions = {
    ...
    tokenizerOptions: {
        ...
        stringTypes: ["''-qq-bs", { quote: "''-qq-bs", prefixes: ["N"], requirePrefix: false }],
