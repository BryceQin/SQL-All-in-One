...
export const functionSignatures: FunctionSignature[] = [
    ...
    { name: 'HOP', params: ['TABLE table', 'descriptor col', 'int slide', 'int size'], returnType: 'table', description: '滑动窗口表值函数', category: 'window' },
    { name: 'TUMBLE', params: ['TABLE table', 'descriptor col', 'int size'], returnType: 'table', description: '滚动窗口表值函数', category: 'window' },
    { name: 'CUMULATE', params: ['TABLE table', 'descriptor col', 'int step', 'int size'], returnType: 'table', description: '累积窗口表值函数', category: 'window' },
    { name: 'SESSION', params: ['TABLE table', 'descriptor col', 'int gap'], returnType: 'table', description: '会话窗口表值函数', category: 'window' },
    { name: 'TUMBLE_START', params: ['TABLE table', 'descriptor col', 'int size'], returnType: 'timestamp', description: '返回滚动窗口起始时间', category: 'window' },
    { name: 'TUMBLE_END', params: ['TABLE table', 'descriptor col', 'int size'], returnType: 'timestamp', description: '返回滚动窗口结束时间', category: 'window' },
    { name: 'HOP_START', params: ['TABLE table', 'descriptor col', 'int slide', 'int size'], returnType: 'timestamp', description: '返回滑动窗口起始时间', category: 'window' },
    { name: 'HOP_END', params: ['TABLE table', 'descriptor col', 'int slide', 'int size'], returnType: 'timestamp', description: '返回滑动窗口结束时间', category: 'window' },
    { name: 'SESSION_START', params: ['TABLE table', 'descriptor col', 'int gap'], returnType: 'timestamp', description: '返回会话窗口起始时间', category: 'window' },
    { name: 'SESSION_END', params: ['TABLE table', 'descriptor col', 'int gap'], returnType: 'timestamp', description: '返回会话窗口结束时间', category: 'window' },
    { name: 'CUMULATE_START', params: ['TABLE table', 'descriptor col', 'int step', 'int size'], returnType: 'timestamp', description: '返回累积窗口起始时间', category: 'window' },
    { name: 'CUMULATE_END', params: ['TABLE table', 'descriptor col', 'int step', 'int size'], returnType: 'timestamp', description: '返回累积窗口结束时间', category: 'window' },
