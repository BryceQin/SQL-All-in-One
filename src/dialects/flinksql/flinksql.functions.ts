...
export const functionSignatures: FunctionSignature[] = [
    ...
    {
        name: "REGEXP_EXTRACT",
        params: ["string s", "string pat", "int idx"],
        returnType: "string",
        description: "提取正则匹配组",
        category: "string",
    },
    {
        name: "REGEXP_REPLACE",
        params: ["string s", "string pat", "string rep"],
        returnType: "string",
        description: "正则替换",
        category: "string",
    },
    ...
    {
        name: "OVERLAY",
        params: ["string s", "string r", "int pos", "int len"],
        returnType: "string",
        description: "替换子串",
        category: "string",
    },
    ...
    {
        name: "TIMESTAMPADD",
        params: ["string unit", "int n", "timestamp t"],
    ...
    {
        name: "TIMESTAMPDIFF",
        params: ["string unit", "timestamp t1", "timestamp t2"],
        returnType: "bigint",
        description: "时间戳差值",
        category: "date",
    },
    ...
    { name: "TO_TIMESTAMP", params: ["string s", "string fmt"], returnType: "timestamp", description: "字符串转时间戳", category: "date" },
    {
        ...
        params: ["bigint ts", "int precision"],
        returnType: "timestamp_ltz",
        description: "转为本地时区时间戳",
        category: "date",
    },
    ...
    {
        name: "HOP",
        params: ["TABLE table", "descriptor col", "int slide", "int size"],
        returnType: "table",
        description: "滑动窗口表值函数",
        category: "window",
    },
    {
        name: "TUMBLE",
        params: ["TABLE table", "descriptor col", "int size"],
        returnType: "table",
    ...
    {
        name: "CUMULATE",
        params: ["TABLE table", "descriptor col", "int step", "int size"],
        returnType: "table",
    ...
    {
        name: "SESSION",
        params: ["TABLE table", "descriptor col", "int gap"],
        returnType: "table",
        description: "会话窗口表值函数",
        category: "window",
    },
    {
        name: "TUMBLE_START",
    ...
    { name: "MAP_VALUES", params: ["map<K,V> m"], returnType: "array<V>", description: "返回 map 的值", category: "collection" },
    {
        ...
        params: ["array<K> keys", "array<V> values"],
        returnType: "map<K,V>",
        description: "从键值数组创建 map",
        category: "collection",
    },
