...
export const functionSignatures: FunctionSignature[] = [
    ...
    {
        name: "NVL2",
        params: ["T a", "T val1", "T val2"],
        returnType: "T",
        description: "若非 NULL 返回 val1，否则 val2",
    ...
    {
        name: "JSON_TUPLE",
        params: ["string json", "string k1", "..."],
        returnType: "多列",
        description: "JSON 提取多个字段",
        category: "json",
    },
    ...
    {
        name: "TRANSFORM",
        params: ["array<T> a", "func<T,U> lambda"],
        returnType: "array<U>",
        description: "对数组每个元素应用 lambda 函数",
        category: "collection",
    },
    {
        name: "FILTER",
        params: ["array<T> a", "func<T,boolean> predicate"],
        returnType: "array<T>",
        description: "过滤数组元素",
        category: "collection",
    },
    {
        name: "AGGREGATE",
        params: ["array<T> a", "U zero", "func<U,T,U> merge"],
        returnType: "U",
        description: "聚合数组元素",
        category: "collection",
    },
    {
        ...
        params: ["array<T> a", "U zero", "func<U,T,U> merge"],
        returnType: "U",
        description: "AGGREGATE 别名",
        category: "collection",
    },
    {
        name: "ZIP_WITH",
        params: ["array<T> a", "array<U> b", "func<T,U,R> combine"],
        returnType: "array<R>",
        description: "按位置组合两数组",
        category: "collection",
    },
    ...
    { name: "ANY_VALUE", params: ["T col"], returnType: "T", description: "返回任意非 NULL 值（Spark 3.4+）", category: "aggregate" },
    {
        ...
        params: ["int|bigint n"],
        returnType: "int",
        description: "返回二进制位 1 的个数（Spark 3.4+）",
        category: "math",
    },
    {
        name: "SPLIT_PART",
        params: ["string s", "string sep", "int part"],
        returnType: "string",
        description: "按分隔符切分取第 n 段（Spark 3.4+）",
        category: "string",
    },
    {
        name: "MAKE_YM_INTERVAL",
        params: ["int years", "int months"],
        returnType: "interval year_month",
        description: "创建年月间隔（Spark 3.4+）",
        category: "date",
    },
    ...
    // --- GENERATOR FUNCTIONS (补全) ---
    {
        ...
        params: ["array<T>|map<K,V> a"],
        returnType: "多行",
        description: "类似 EXPLODE 但保留 NULL 输入",
        category: "table",
    },
    {
        ...
        params: ["array<T>|map<K,V> a"],
        returnType: "多行含位置",
        description: "类似 POSEXPLODE 但保留 NULL 输入",
        category: "table",
    },
];
