...
export const functionSignatures: FunctionSignature[] = [
    ...
    },
    {
        ...
        params: ["T col"],
        returnType: "array",
        description: "聚合组内值为数组（保留顺序与重复）",
        category: "aggregate",
    },
    { name: "COLLECT_SET", params: ["T col"], returnType: "array", description: "聚合组内值为去重数组", category: "aggregate" },
    {
        name: "PERCENTILE_APPROX",
        params: ["numeric col", "double p"],
        returnType: "double",
        description: "返回近似百分位数",
        category: "aggregate",
    },
    {
        name: "EXPLODE",
        params: ["array|map col"],
        returnType: "table",
        description: "将数组或 Map 展开为多行（配合 LATERAL VIEW 使用）",
        category: "table",
    },
    {
        name: "EXPLODE_SPLIT",
        params: ["string s", "string sep"],
        returnType: "table",
        description: "按分隔符切分字符串并展开为多行",
        category: "table",
    },
