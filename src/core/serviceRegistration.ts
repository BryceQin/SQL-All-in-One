...
export function registerServicesToContainer(container: DIContainer, extensionPath: string): void {
    ...
    container.registerSingleton(Tokens.SqlDiagnosticsProvider, () => {
    ...
    container.registerSingleton(Tokens.StatusBarProvider, () => {
    ...
    container.registerSingleton(Tokens.QueryService, () => new QueryServiceImpl(), [
        Tokens.QueryExecutor,
        Tokens.ConnectionManager,
    ]);
    container.registerSingleton(Tokens.SchemaService, () => new SchemaServiceImpl(), [
        Tokens.SchemaCache,
        Tokens.ConnectionManager,
    ]);
    container.registerSingleton(Tokens.DataEditService, () => new DataEditServiceImpl(), [
        Tokens.ConnectionManager,
    ]);
    ...
    container.registerSingleton(Tokens.DialectMetadataProvider, () => new DialectMetadataProviderImpl(), [
        Tokens.DialectAdapterFactory,
    ]);
