...
export class DatabaseModule implements Activatable {
    ...
    registerCommands(): void {
        ...
        const { disposables: queryDisposables } = registerQueryCommands(this.context, this);
        const exportDisposables = registerExportCommands();
        const schemaDisposables = registerSchemaCommands(this.context, this);

        const allDisposables = [...connectionDisposables, ...queryDisposables, ...exportDisposables, ...schemaDisposables];
            ...
            if (event.newState === "connected") {
                ...
                if (config && config.database) {
                    ...
                    vscode.commands.executeCommand(
                        "setContext",
                        "hive-formatter.connectionCount",
