...
const RELEVANT_KEYS: (keyof FormatOptions)[] = [
    ...
    "newlineBetweenCtes",
    "cteCommaPosition",
    "indentJoinConditions",
    "alignOnClauses",
    "alignInsertColumns",
    "alignInsertValuesGroups",
    "newlineAfterInsertColumns",
    "newlineBetweenValuesGroups",
    "newlineAfterCase",
    "newlineAfterWhen",
    "newlineAfterThen",
    "newlineAfterElse",
    ...
    "subqueryParenStyle",
    "commentPosition",
    "blankLinesBeforeSetOperation",
    "blankLinesAfterSetOperation",
    "newlineBeforeLateralView",
    "newlineBeforeDistributeBy",
    "newlineBeforeClusterBy",
    "newlineBeforeSortBy",
];
...
export const formatDialect = (query: string, { dialect, ...cfg }: FormatOptionsWithDialect): string => {
    if (typeof query !== "string") {
        throw new Error(t("validate.invalidQueryType", typeof query));
    }
