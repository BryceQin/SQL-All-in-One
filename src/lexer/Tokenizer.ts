...
export default class Tokenizer {
    ...
    public resolveParamTypes(paramTypesOverrides?: ParamTypes): ResolvedParamTypes {
        return {
            ...
            positional:
                typeof paramTypesOverrides?.positional === "boolean" ? paramTypesOverrides.positional : this.cfg.paramTypes?.positional,
    ...
    private buildParamRules(cfg: TokenizerOptions, paramTypesOverrides?: ParamTypes): TokenRule[] {
        ...
        if (this.cachedParamRules && this.cachedParamTypes && this.paramTypesEqual(this.cachedParamTypes, paramTypes)) {
    ...
    private buildParamRulesImpl(cfg: TokenizerOptions, paramTypes: ResolvedParamTypes): TokenRule[] {
        return this.validRules([
            // 匹配命名参数（如 :user_id）
            {
