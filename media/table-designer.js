...
function updateColumn(id, field, value) {
    let col = state.columns.find(function (c) {
        return c.id === id;
    });
    if (!col) return;
    col[field] = value;
...
function onFieldDrop(e) {
    ...
    let fromIdx = state.columns.findIndex(function (c) {
        return c.id === dragState.dragId;
    });
    let toIdx = state.columns.findIndex(function (c) {
...
function updateIndex(id, field, value) {
    let idx = state.indexes.find(function (i) {
        return i.id === id;
    });
    if (!idx) return;
    idx[field] = value;
...
function updateForeignKey(id, field, value) {
    let fk = state.foreignKeys.find(function (f) {
        return f.id === id;
    });
    if (!fk) return;
    fk[field] = value;
...
function updateTrigger(id, field, value) {
    let trg = state.triggers.find(function (t) {
        return t.id === id;
    });
    if (!trg) return;
    trg[field] = value;
