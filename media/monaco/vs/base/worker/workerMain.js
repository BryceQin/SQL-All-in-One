            ...
            requireToUrl(d) {
                ...
                return (
                    q.Utilities.isAbsolutePath(g) ||
                        ((g = this._applyPaths(g)[0]), q.Utilities.isAbsolutePath(g) || (g = this.options.baseUrl + g)),
        ...
        class i {
            ...
            load(o, C, e, a) {
                if (/^node\|/.test(C)) {
                    ...
                    if (
                        !(/^((http:)|(https:)|(file:))/.test(C) && C.substring(0, self.origin.length) !== self.origin) &&
                        this._canUseEval(o)
                    ) {
                        fetch(C)
                            .then((m) => {
            ...
            load(o, C, e, a) {
                ...
                if (/^node\|/.test(C)) {
                    ...
                    this._readSourceAndCachedData(S, y, f, (_, r, s, l) => {
                        ...
                        let p;
                        (r.charCodeAt(0) === d._BOM ? (p = d._PREFIX + r.substring(1) + d._SUFFIX) : (p = d._PREFIX + r + d._SUFFIX),
                            (p = m(p, S)));
                ...
                typeof _.loadBundle == "function"
                    ...
                    : _.translationServiceUrl && !s
                      ? (async () => {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    return (
                                        ((b = _.availableLanguages) !== null && b !== void 0) || (_.availableLanguages = {}),
                      ...
                      : S([f + l], p, (b) => {
                            ...
                            (console.error(`Failed to load message bundle for language ${r}. Falling back to the default language:`, b),
                                S([f + ".nls"], p));
                        });
            }
            n.load = m;
            ...
            class i {
                ...
                static _hue2rgb(h, o, C) {
                    return (
                        C < 0 && (C += 1),
                        C > 1 && (C -= 1),
                        C < 1 / 6 ? h + (o - h) * 6 * C : C < 1 / 2 ? o : C < 2 / 3 ? h + (o - h) * (2 / 3 - C) * 6 : h
                    );
                }
                static toRGBA(h) {
                    const o = h.h / 360,
...
`),
                    ...
                    ((this._size = 0),
                        ...
                        (this._leakageMon =
                            e > 0 || (!((R = this._options) === null || R === void 0) && R.leakWarningThreshold)
                                ...
                                : void 0),
                        (this._perfMon =
                            !((x = this._options) === null || x === void 0) && x._profName ? new C(this._options._profName) : void 0),
        ...
        X(J[6], Z([0, 1, 32, 36]), function (q, n, M, A) {
            ...
            function m(P, B, W = {}) {
                ...
                (B || (P = o(P)),
                    W.wholeWord && (/\B/.test(P.charAt(0)) || (P = "\\b" + P), /\B/.test(P.charAt(P.length - 1)) || (P = P + "\\b")));
                let $ = "";
                return (
                    W.global && ($ += "g"), W.matchCase || ($ += "i"), W.multiline && ($ += "m"), W.unicode && ($ += "u"), new RegExp(P, $)
                );
            }
            n.createRegExp = m;
            function f(P) {
            ...
            class c {
                            ...
                            : w < 2048
                              ...
                              : w < 65536
                                ...
                                : ((f[S++] = 240 | ((w & 1835008) >>> 18)),
                                  ...
                                  (f[S++] = 128 | ((w & 63) >>> 0))),
                        S >= 64 &&
                            (this._step(), (S -= 64), (this._totalLen += 64), (f[0] = f[64 + 0]), (f[1] = f[64 + 1]), (f[2] = f[64 + 2])),
                        S
                    );
                }
                digest() {
                ...
                _step() {
                    ...
                    for (let b = 64; b < 320; b += 4)
                        f.setUint32(
                            b,
                            C(f.getUint32(b - 12, !1) ^ f.getUint32(b - 32, !1) ^ f.getUint32(b - 56, !1) ^ f.getUint32(b - 64, !1), 1),
                            !1,
                        );
                    let w = this._h0,
                        E = this._h1,
                ...
                PrettifyChanges(e) {
                    for (let a = 0; a < e.length; a++) {
                        ...
                        for (
                            ...
                            if (this.ElementsAreStrictEqual(u.originalStart + u.originalLength, u.modifiedStart + u.modifiedLength) && !E)
                                break;
                ...
                compute(o, C, e = A.InfiniteTimeout.instance) {
                    ...
                    e: for (;;) {
                        ...
                        for (w = s; w <= l; w += 2) {
                            ...
                            if ((S.set(w, D !== R ? new d(x, R, N, D - R) : x), f.get(w) === a.length && f.get(w) - w === u.length))
                                break e;
                        }
                    }
                    let E = S.get(w);
                    ...
                    for (;;) {
                        const s = E ? E.x + E.length : 0,
                            l = E ? E.y + E.length : 0;
                        if (((s !== _ || l !== r) && y.push(new A.SequenceDiff(new M.OffsetRange(s, _), new M.OffsetRange(l, r))), !E))
                            break;
...
`).length >= 15 && u(D, (T) => T.length >= 2) >= 2
            ...
            function c(E, y, _, r) {
                const s = [],
                    ...
                    p = new Set(
                        E.filter((v) => v.original.isEmpty && v.modified.length >= 3).map((v) => new C.LineRangeFragment(v.modified, _, v)),
                    ),
                    b = new Set();
                for (const v of l) {
                    let R = -1,
                    ...
                    if (
                        (R > 0.9 && N && (p.delete(N), s.push(new A.LineRangeMapping(v.range, N.range)), b.add(v.source), b.add(N.source)),
                        !r.isValid())
                    )
            ...
            class f {
                                ...
                                for (let Y = 0; Y < H; Y++) {
                                    ...
                                    if (y[t] !== _[re]) {
                                        const le = this.refineDiff(
                                            y,
                                            _,
                                            new L.SequenceDiff(new d.OffsetRange(t, t + 1), new d.OffsetRange(re, re + 1)),
                                            s,
                                            l,
                                        );
                ...
                refineDiff(y, _, r, s, l) {
                    ...
                    return (
                        ...
                        {
                            mappings: R.map((D) => new u.RangeMapping(p.translateRange(D.seq1Range), b.translateRange(D.seq2Range))),
            ...
            class d {
                ...
                _acceptInsertText(L, h) {
                    ...
                    for (let e = 1; e < o.length; e++)
                        (this._lines.splice(L.lineNumber + e - 1, 0, o[e]), (C[e - 1] = o[e].length + this._eol.length));
...
`
                    ...
                    for (y.reset(0); (R = y.next(l));)
                        if (((b[v++] = C(this._getMultilineMatchRange(w, s, l, p, R.index, R[0]), R, _)), v >= r)) return b;
                    return b;
                }
                ...
                static _findMatchesInLine(w, E, y, _, r, s, l, p) {
                    ...
                    if (!l && w.simpleSearch) {
                        ...
                        for (; (T = E.indexOf(N, T + D)) !== -1;)
                            if (
                                (!b || m(b, E, x, T, D)) &&
                                ((s[r++] = new g.FindMatch(new d.Range(y, T + 1 + _, y, T + 1 + D + _), null)), r >= p)
                            )
                                return r;
                        return r;
                    }
                    ...
                    do
                        if (
                            ((R = v.next(E)),
                            R && ((s[r++] = C(new d.Range(y, R.index + 1 + _, y, R.index + 1 + R[0].length + _), R, l)), r >= p))
                        )
                            return r;
                    while (R);
                    return r;
            ...
            class o {
                ...
                getCandidateCodePoints() {
                    ...
                    if (this.options.invisibleCharacters)
                        for (const u of i.InvisibleCharacters.codePoints) C(String.fromCodePoint(u)) || a.add(u);
                            ...
                            if (N === 2) {
                                if (b.length < 2 || v !== 2 || b.charCodeAt(b.length - 1) !== L || b.charCodeAt(b.length - 2) !== L) {
                                    if (b.length > 2) {
                                        ...
                                        (T === -1 ? ((b = ""), (v = 0)) : ((b = b.slice(0, T)), (v = b.length - 1 - b.lastIndexOf(l))),
                                            (R = x),
                                            (N = 0));
                                        continue;
                                    } else if (b.length !== 0) {
            ...
            n.win32 = {
                ...
                normalize(r) {
                    ...
                    if (f(v))
                        ...
                        w(v) && r.charCodeAt(1) === C && ((p = r.slice(0, 2)), (l = 2), s > 2 && f(r.charCodeAt(2)) && ((b = !0), (l = 3)));
        ...
        X(J[18], Z([0, 1, 63, 17]), function (q, n, M, A) {
            ...
            class u {
                ...
                with(p) {
                    ...
                    return (
                        ...
                        b === this.scheme && v === this.authority && R === this.path && N === this.query && D === this.fragment
                            ? this
                            : new m(b, v, R, N, D)
                    );
                }
            ...
            function y(l, p) {
                ...
                if ((R && ((v += R), (v += ":")), (N || R === "file") && ((v += e), (v += e)), N)) {
                    ...
                    ((N = N.toLowerCase()),
                        (F = N.lastIndexOf(":")),
                        F === -1 ? (v += b(N, !1, !0)) : ((v += b(N.substr(0, F), !1, !0)), (v += N.substr(F))));
                }
                if (D) {
            ...
            class f {
                ...
                _handleReplyMessage(l) {
                    ...
                    if ((delete this._pendingReplies[l.seq], l.err)) {
                        let b = l.err;
                        (l.err.$isError && ((b = new Error()), (b.name = l.err.name), (b.message = l.err.message), (b.stack = l.err.stack)),
                            p.reject(b));
                        return;
                    }
                    p.resolve(l.res);
            ...
            function (q, n, M, A, i, d, g, L, h, o, C, e, a, u, c, m) {
                ...
                class S {
                    ...
                    async computeMoreMinimalEdits(y, _, r) {
                        ...
                        return (
                            typeof p == "number" &&
                                l.push({ eol: p, text: "", range: { startLineNumber: 0, startColumn: 0, endLineNumber: 0, endColumn: 0 } }),
                            l
                        );
                    }
                        ...
                        e: for (const v of y) {
                            ...
                            if (R) {
                                for (const N of R.words(p))
                                    if (!(N === _ || !isNaN(Number(N))) && (b.add(N), b.size > S._suggestionsLimit)) break e;
                            }
                        }
