...
(function (u) {
    class y {
        ...
        static recursiveClone(p) {
            if (!p || typeof p != "object" || p instanceof RegExp || (!Array.isArray(p) && Object.getPrototypeOf(p) !== Object.prototype))
                return p;
...
(function (u) {
    ...
    class p {
        ...
        getModuleId(t) {
            ...
            return (
                typeof e > "u" && ((e = this._nextId++), this._strModuleIdToIntModuleId.set(t, e), (this._intModuleIdToStrModuleId[e] = t)),
                e
            );
        }
        getStrModuleId(t) {
