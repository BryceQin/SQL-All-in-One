...
const toKeywordNode = (token) => ({
    type: ast_1.NodeType.keyword,
    tokenType: token.type,
    text: token.text,
    raw: token.raw,
});
const toDataTypeNode = (token) => ({
    type: ast_1.NodeType.data_type,
    text: token.text,
    raw: token.raw,
});
...
const grammar = {
    ...
    ParserRules: [
        ...
        },
        {
            ...
            symbols: [
                lexer.has("DELIMITER") ? { type: "DELIMITER" } : DELIMITER,
            ],
        },
        {
            name: "statement$subexpression$1",
        ...
        },
        {
            ...
            postprocess: ([children, [delimiter]]) => ({
                type: ast_1.NodeType.statement,
                children,
                hasSemicolon: delimiter.type === token_1.TokenType.DELIMITER,
            }),
        },
        ...
        { name: "limit_clause$ebnf$1", symbols: [], postprocess: () => null },
        {
            ...
            postprocess: ([limitToken, _, exp1, optional]) => {
                if (optional) {
                    ...
                    return {
                        type: ast_1.NodeType.limit_clause,
        ...
        },
        {
            ...
            postprocess: () => ({ type: ast_1.NodeType.all_columns_asterisk }),
        },
        ...
        },
        {
            ...
            postprocess: ([nameToken, children]) => ({
                type: ast_1.NodeType.set_operation,
                nameKw: toKeywordNode(nameToken),
                children,
            }),
        },
        ...
        },
        {
            ...
            postprocess: ([arrayToken, _, brackets]) => ({
                type: ast_1.NodeType.array_subscript,
                array: addComments({
                    type: ast_1.NodeType.identifier,
                    quoted: false,
        ...
        },
        {
            ...
            postprocess: ([nameToken, _, parens]) => ({
                type: ast_1.NodeType.function_call,
        ...
        },
        {
            ...
            postprocess: ([open, children, close]) => ({
                type: ast_1.NodeType.parenthesis,
                children: children,
                openParen: "(",
                closeParen: ")",
            }),
        ...
        { name: "property_access$subexpression$1", symbols: ["parameter"] },
        {
            ...
            ([object, _1, dot, _2, [property]]) => {
                return {
                    type: ast_1.NodeType.property_access,
        ...
        },
        {
            ...
            postprocess: ([betweenToken, _1, expr1, _2, andToken, _3, expr2,]) => ({
                type: ast_1.NodeType.between_predicate,
        ...
        },
        {
            ...
            postprocess: ([caseToken, _, expr, clauses, endToken]) => ({
                type: ast_1.NodeType.case_expression,
        ...
        },
        {
            ...
            postprocess: ([[token]]) => ({ type: ast_1.NodeType.comma }),
        },
        {
        ...
        },
        {
            ...
            postprocess: ([nameToken, _, parens]) => ({
                type: ast_1.NodeType.parameterized_data_type,
        ...
        },
        {
            ...
            postprocess: ([token]) => ({
                type: ast_1.NodeType.line_comment,
                text: token.text,
        ...
        },
        {
            ...
            postprocess: ([token]) => ({
                type: ast_1.NodeType.block_comment,
                text: token.text,
                precedingWhitespace: token.precedingWhitespace,
            }),
        },
        {
            ...
            postprocess: ([token]) => ({
                type: ast_1.NodeType.disable_comment,
                text: token.text,
                precedingWhitespace: token.precedingWhitespace,
            }),
        },
