...
const hive_functions_1 = require("./hive.functions");
const hive_keywords_1 = require("./hive.keywords");
...
const reservedPhrases = (0, expandPhrases_1.expandPhrases)(["{ROWS | RANGE} BETWEEN"]);
...
exports.hive = {
    ...
    tokenizerOptions: {
        ...
        reservedKeywords: hive_keywords_1.keywords,
        reservedDataTypes: hive_keywords_1.dataTypes,
        reservedFunctionNames: hive_functions_1.functions,
        extraParens: ["[]"],
        stringTypes: ['""-bs', "''-bs"],
        identTypes: ["``"],
